...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		define([ "../../../../layout_include_global/js/jquery" ], factory );
	} else {
...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		dayNames: ["Segunda", "Ter&ccedil;a", "Quarta", "Quinta", "Sexta", "S&aacute;bado", "Domingo"], // For formatting
		dayNamesShort: ["Seg", "Ter", "Qua", "Qui", "Sex", "S&aacute;b", "Dom"], // For formatting
